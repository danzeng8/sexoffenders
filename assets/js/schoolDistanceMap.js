...
var findSchoolOffenderDistances = function(polygon) {
	...
	schoolDistanceCanvas.append("text")
			.attr("x", marginX+(2.5*graphWidth / 10.0)-(0.25*marginX))
			.attr("y", marginY + graphHeight + (0.5*marginY))
			.text("1000-2000 feet");
	...
	schoolDistanceCanvas.append("text")
			.attr("x", marginX+(5*graphWidth / 10.0)-(0.25*marginX))
			.attr("y", marginY + graphHeight + (0.5*marginY))
			.text("2000-4000 feet");
	...
	schoolDistanceCanvas.append("text")
			.attr("x", marginX+(7.5*graphWidth / 10.0)-(0.25*marginX))
			.attr("y", marginY + graphHeight + (0.5*marginY))
			.text("4000-10000 feet");
